...
local vivaldi      = "vivaldi-stable"
local chrome       = "google-chrome-stable"
local guieditor    = "code-oos"
...
globalkeys = my_table.join(
    ...
    awful.key({ altkey, "Control" }, "Delete", function ()
        os.execute(string.format("i3exit %s",'lock'))
        end,
    ...
    awful.key({ }, "XF86AudioRaiseVolume",
        function ()
            os.execute("amixer -D pulse sset Master 5%+ && paplay /usr/share/sounds/freedesktop/stereo/audio-volume-change.oga")
    ...
    awful.key({ }, "XF86AudioMute",
        function ()
            os.execute("amixer -D pulse sset Master toggle-mute")
            beautiful.volume.update()
        end,
...
--  Menubar
    ...
    --           {description = "lua execute prompt", group = "awesome"}),
        ...
        -- User programs
        awful.key({ modkey, "Shift" }, "v", function () awful.spawn(vivaldi) end,
...
for i = 1, 9 do
    ...
    if i == 1 or i == 9 then
        ...
        descr_move_focus = {description = "move focused client to tag # and focus tag", group = "tag"}
